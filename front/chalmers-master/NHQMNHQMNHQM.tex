...
\covercaption{An illustration of the loosely bound \He{6} halo nuclei. The system is called \emph{Borromean} after the Borromean rings, because while the entire system forms a bound state, removing one of the components will make the remainder fall apart as well. In our model, described in detail in Chapter 6, the system is treated as three interacting particles.} 
