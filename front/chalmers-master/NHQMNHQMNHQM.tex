...
\covercaption{An illustration of the loosely bound halo nuclei \He{6}. The system is called \emph{Borromean} after the Borromean rings, because while the entire system forms a bound state, removing one of the components will make the remainder fall apart as well. In our model, described in detail in \cref{cha:three-body}, the system is treated as three interacting particles.} 
