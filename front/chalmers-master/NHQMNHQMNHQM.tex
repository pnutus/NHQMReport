...
\coverfigure{\includegraphics[width=0.7\textwidth,height=0.4\paperheight,keepaspectratio]{../../figures/helium.pdf}}
%{../../presentation/helium_3d.pdf}}
\covercaption{An illustration of the loosely bound \He{6} halo nucleus, which can be thought of as three particles: two neutrons and an alpha-particle core.  While the entire system forms a bound state, removing any one particle will make the other two fall apart. The nucleus is called \emph{Borromean} after the three Borromean rings that also fall apart when one is removed.
} 
