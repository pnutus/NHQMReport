...
För att göra detta har vi löst Schrödingerekvationen på matrisform med basexpansion i en komplex berggrenbas.
...
\begin{eq}
  \label{eq:expand3}
  H\phi_n = \bra{n} H \ket{n'} = \sum_{n'} H_{nn'} \psi_{n'} = E \psi_n,
\end{eq}
