...
\Large Kandidatrapport i fysik, svensk sammanfattning FUFX02–13–03 }
...
Kvadraturen används även för att beräkna integraler vid beräkning av matriselement.

\section{\He{5}-systemet}
...
Schrödingerekvationen för \He{5}-system löses i både harmoniska oscillatorbasen och rörelsemängdsbasen. Den harmoniska oscillatorn är ett stängt system med bara bundna egenlösningar och passar därför dåligt för att analysera det öppna \He{5}-systemet. 
...
\centering{
  ...
  \caption{
    \He{5} Vågfunktioner för olika starka potentialer. Den unika lokaliserade lösningen till SE markers i rött och en vanlig obunden lösning visas i grått.
    Till vänster uppvisar en stark potential $V_0 = \SI{70}{MeV}$ ett bundet tillstånd medan vi har ett lokaliserat obundet tillstånd till höger vid potentialen $V_0 = \SI{47}{MeV}$.
  } 
  }
