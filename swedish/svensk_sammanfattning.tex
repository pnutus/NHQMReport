...
Vi behandlar \He{5} och \He{6} i en fåkropparsbild som en alfapartikel med en eller två valensneutroner.
...
Vi använder komplexrörelsemängdsmetoden för att återskapa experimentella värden för \He{5} resonansen.
Berggrenbas lösningarna för \He{5} används som enpartikeltillstånd i flerpartikelbasen för att utveckla \He{6}. 
Vi använder två olika modeller för neutronväxelverkan: en gaussisk och ytdeltainteraktion (SDI). 
Deras respektive styrka anpassas för att överenstämma med \He{6}s grundenergi.
Vi kan endast finna \He{6} resonansen med SDI växelverkan.
Relevanta delar av ockupationstals representations teorin summeras och implementeras.
...
\begin{figure}[ht]
  \centering
  	\includegraphics[page=1]{../figures/eigvecs_real_comp_se/eigvecs.pdf}
...
\begin{figure}
  \centering{
      ...
      \includegraphics[page=2]{../figures/poles(contour)_se/poles.pdf}
  }
