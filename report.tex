...
\newpage
\begin{abstract}
This thesis studies loosely bound quantum systems by expanding in a complex basis using numerical methods. This is done by studying
resonances in \He{5} and \He{6} nuclei. We explain the theory of basis
expansion and expand the \He{5} nucleus wave functions in the spherical harmonic oscillator
and plane wave bases. Our model systems are a \He{4} nucleus with one and two orbiting neutrons, respectively.
...
\chapter{Introduction}\todo{Many references in introduction.}
