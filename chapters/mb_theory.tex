...
Taking it into account we see that the three-body solution may contain two bodies with the same energy (same $n$), but with different $m$-number.\todo{New paragraph, is it better? (top one is new.)}
