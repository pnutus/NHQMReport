...
A fact of quantum mechanics is that particles that look identical \emph{are} identical. In our case there is no way to distinguish two neutrons orbiting the core from one another. This has to be taken into consideration when dealing with the states, as we will soon see.
