...
\todo{adapted from dickhoff (suhonen) PONTUS}
...
\todo[inline]{pauli principle PONTUS}
\todo[inline]{completeness relation? Orthonormality? PONTUS}
...
The following section will thus introduce the concept of angular momentum coupling. \todo{refer to souhonen or somewhere where this coupling is satisfactorily explained PONTUS}
...
The transformation is done with the coefficients $c_{m_1 m_2}$, formally written as
\begin{eq}
  c_{m_1 m_2} = \pbraket{j_1 m_1, j_2 m_2}{JM},
\end{eq}
known as the \emph{Clebsch-Gordan coefficients}. There are known expressions for these, and values can be found in standard tables or calculated in a fairly straigth-forward way. Suhonen\cite{suhonen} gives a detailed discussion of this.
...
\todo{Write about matrix elements in entire chapter PONTUS}
...
\todo{read through, do we need more justification? VINCENT OLA}
...
\todo{finish this section PONTUS}
