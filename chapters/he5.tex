...
For a strong potential $V_0 =$ \SI{-70}{MeV} we find the bound solution, $E= $ \SI{-4.84}{MeV}, and the basis momenta, which is what we expected.
For a weaker $V_0 =$ \SI{-50}{MeV} potential, on the other hand, we expect to find no bound solution but instead a resonant state. 
...
\begin{figure}[H]
   ...
   \subfloat[Real Contour]{
     \tikzset{external/remake next}
 \tikzsetnextfilename{realcont}
     \begin{tikzpicture}
       \begin{axis}[
  ...
  \caption{momentum solutions to the Shrödinger equation expanded along the real axis for \he{5} with a potential of $V_0 =$ \SI{-70}{MeV}. ska vi visa "flatland panoramat" som vi får för -50mev?} 
...
Our results from investigating this is presented in \cref{fig:Dolan pls}.
