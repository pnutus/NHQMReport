When we move on to the problem of the \He{5} nucleus we see it as an alpha core (\He{4}) with a vanence neutron which moves in the potential of the alpha core.
...
Let us study the obtained solutions closer. \Cref{fig:resonance wavefunction} shows the radial wavefunctions $R(r)$ for a few of the states with lowest energy.
