    ...
    \begin{axis}[
      ...
      height = 9cm,
        ...
        no markers,
      	...
      	\addplot+[color = red, very thick, ->] table [x index = 0, y index = 1] {../figures/res_pole(V0)/poles.data};
...
\caption{\He{5} momentum probability distributions for a real and complex contour. The resonance is more prominent when solving along the complex contour but is significantly lower and wider than the surrounding states in both cases. Both contours comprise 60 points in total, but the points in the complex contour are focused near the origin. The density fluctuation stems from the gauss-legedre distribution on the individual segments.} 
...
\begin{figure}
  ...
  \caption{\He{5} $p_{3/2}$ wave solutions in the complex momentum plane for different contours. The resonance is located at $0.1731, -0.03558i$ for both contours. we have used $V0 =$ \SI{47}{MeV} with $k_{max} =$ \SI{5}{fm^{-1}} with 60 points on both contours.} 
