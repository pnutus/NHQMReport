...
Using a complex momentum basis effectively means that we\todo{instead of what?} evaluate the integral along a complex contour. 
...
A curious result following from this procedure is that the ordinary scalar product, and thus the norm,
\begin{eq}
