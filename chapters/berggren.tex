...
This follows from Cauchy's theorem, and the fact that the resonance corresponds to a pole in the complex plane.\todo{Should we say that it is required, or just investigate different contours and find out?}
