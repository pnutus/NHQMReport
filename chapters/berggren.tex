...
\todo{resulting poles in table VINCENT}

\begin{table}[H]
  \begin{tabular}{c|c|c}
    Wave      & Experimental $k_r$  & Contour vertices \\
    \hline
...
at (axis cs:0.17,-0.0346) {};
      ...
      \end{axis}
  \end{tikzpicture}
  \caption{The position of the resonance pole as a function of $V_0$. The pole begins as a bound state on the imaginary axis, gradually becomes less and less bound, jumps into the fourth quadrant and moves down and to the right.}
  \label{fig:pole(V0)}
\end{figure}
