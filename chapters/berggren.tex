...
We also found that we could vary the depth of the contour to some extent without the resonance pole moving. 
But with sufficiently large imaginary parts, the matrix element integrals started to diverge. \todo[inline]{gillar inte riktigt formuleringen, lite informellt. kontur djup? }
Barring such numerical errors, we found that any contour that runs below the pole gives a stable resonance solution. \todo[inline]{halvsanning?}
