...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
  \caption{A schemtic picture of the discretized complex contour. The points are distributed on each segment according to the Gauss-Legendre quadrature rule.}
