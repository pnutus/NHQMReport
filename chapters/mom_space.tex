...
\todo{Rename this section ``Discretization''? Combine with HO stuff}
...
\end{eq}
where $w_j$ are the quadrature weights. \todo{Explain quadrature in one sentence?} 
...
\end{eq}
\todo{This paragraph is a repeat of something else.}
