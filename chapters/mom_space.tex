...
\end{eq} 
We transformed the differential equation into an integral equation
\begin{eq}
  \fint[0][\inf]{k'} \p{
...
We use the Gauss-Legendre quadrature \cite{gauss-legendre}.
...
Working with a symmetric matrix will be faster, why we do the transformation
\begin{eq}
  \phi_i &\mapsto
