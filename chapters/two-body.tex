...
In this section we will apply those methods to solve the Schrödinger equation and subsequently study the solutions.
...
The unique state peaks at $k = \SI{0.17}{fm^{-1}}$ and is slightly wider than the other states. 
