...
\todo{read through entire chapter OLA VINCENT SPILL}
...
Nuclei are commonly studied within a shell model.
This is done by introducing a \emph{mean-field} potential, often done in the following way.\cite{suhonen}
