...
However, the change in behavior is small, and we cannot draw any definite conclusions about the state from this observation. 
The only thing that can be said is that the state has a slightly different behavior near $r=\SI{1}{fm}$ compared to ordinary scattering states.
