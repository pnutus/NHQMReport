  ...
  \tikzsetnextfilename{wavefunction-70MeV}
      \begin{tikzpicture}
        \begin{axis}
          ...
          \addplot+[densely dotted] table[x index=0, y index=2] {\wavefunctions};
		  						  	\addlegendentry{E = \SI{5.63}{MeV}}
        \end{axis}
      \end{tikzpicture}
    }
...
\tikzsetnextfilename{wavefunction-60MeV}
    \begin{tikzpicture}
      \begin{axis}
        ...
        \addplot+[densely dotted] table[x index=0, y index=4] {\wavefunctions};
								  	\addlegendentry{E = \SI{5.75}{MeV}}
      \end{axis}
    \end{tikzpicture}
  } \\
...
\tikzsetnextfilename{wavefunction-52MeV}
    \begin{tikzpicture}
      \begin{axis}
        ...
        \addplot+[densely dotted] table[x index=0, y index=6] {\wavefunctions};
...
\tikzsetnextfilename{wavefunction-47MeV}
    \begin{tikzpicture}
      \begin{axis}
        ...
        \addplot+[densely dotted] table[x index=0, y index=8] {\wavefunctions};
  ...
  \caption{Displayed above are the wavefunctions of the one localized solution (solid) and and an arbitrary continuum solution (dashed).} 
