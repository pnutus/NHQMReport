...
There is a background of wavefunctions peaking at different values of $k$, and, once again, one of the functions stand out by being lower and wider. Let us first discuss the peak-shaped wavefunctions.
...
As we decrease the depth below a certain threshold, the potential well no longer supports the bound state ($E > 0$), but the wavefunction is still localized.
