...
Typical examples of open quantum systems are encountered in nuclear physics. The atomic nucleus is held together by the very short-range strong interaction acting between nucleons. \todo[inline]{typical?}
These are systems that can be studied within a shell model. \todo[inline]{really short sentance}
In this framework, the nucleons are modelled as interacting with a \emph{mean-field} potential, approximating an effective interaction the nucleons experience. \todo[inline]{jag gillar inte flödet i sista satsen, man hakar upp sig}\todo{Do the proper derivation?}
...
\begin{figure}[ht!]
  \pgfplotstableread{../figures/E(r0)/E(r0).data}\Ernoll
  \centering
  \begin{tikzpicture}
    \begin{axis}[
      width = \textwidth,
...
\todo{More structure. Subsubsection?}
