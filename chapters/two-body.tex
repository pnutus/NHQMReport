...
\begin{figure}[t]
  ...
  \caption{The effective Woods-Saxon potential with spin-orbit coupling and centrifugal barrier $l(l+1)/2\mu r^2$ added, for $p_{3/2}$ and $p_{1/2}$ waves. The parameters used are $V_0 = \SI{47}{MeV}$, $V\sub{so} = \SI{-7.5}{MeV}$, $r_0 = \SI{2}{fm}$ and $d = \SI{0.65}{fm}$.}
