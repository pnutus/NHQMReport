...
\section{Implementation} \todo{Combine implementation for HO and mom}
...
\section{Results}
A comparison of performance between HO and momentum basis expansion for the hydrogen atom and Helium-5 problems is shown in \cref{fig:HO vs mom}.
\begin{figure}
  \centering
