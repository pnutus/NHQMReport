...
If we considered three-dimensional systems with arbitrary potentials, the matrices would be very large and solving the problem would become infeasible.\todo{infeasable?}
...
\todo{include block diagonal figur, also in text.}
