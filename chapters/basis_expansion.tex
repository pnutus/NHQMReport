...
However, the Hamiltonian written as in \cref{eq:TISEpos}, it is not suitable for numerical calculations. \todo{cite/explain}
...
Working with a symmetric matrix will be faster, hence we perform \todo{why?/explain more}
the transformation
\begin{eq}
  \phi_i &\mapsto
