...
We started by expanding the wavefunction of \He{5} in harmonic oscillators, but found that it was of no use when examining resonances.
...
To speed up calculations we investigated the use of a Monte-Carlo approach to both \He{5} and \He{6}.
We found this to not work well at all, since not were able to find neither the resonances in \ce{^{5,6} He} nor the bound state in \He{6}.
...
\todo[inline]{Not shure if itemize is the best way to present this. Discussion?}
...
\subsection{More nucleons}
  \begin{itemize}
    \item We have confined ourselves to the nuclei of \He{5} and \He{6} in this thesis.
