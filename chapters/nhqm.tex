As previously mentioned (depends on where this text is placed.), NHQM sometimes arise when one observes the binding momentum, related to the energy eigenvalues as
\begin{eq}
    p=\sqrt{2mE}.
\end{eq}
