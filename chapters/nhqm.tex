...
We use this pole to fix our basis for future calculations by variate the depth of the potential and locate the pole after experimental data.

At first we did not find the resonance since we only looked at the energy with the lowest real part.
It was not until after we plotted the energies respective wavefunctions we found the resonance, which now was clearly visible.

We also noticed some interesting behavior of this pole by playing around with our parameters.
