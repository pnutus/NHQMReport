...
\begin{figure}
   ...
   \caption{Momentum solutions for \He{6}, $2^+$. The resonance is located at $k=\SI{0.241-0.037i}{fm^{-1}}$. We have used the fitted Woods-Saxon parameters $V0 = \SI{47.05}{MeV}$, $V\sub{so} = \SI{-7.04}{MeV}$ and $k\sub{max} = \SI{2.5}{fm^{-1}}$. The SDI interaction was used with $V_0=\SI{998}{MeV}$. }
