...
We now have to take into account the attractive two-body interaction between the neutrons, which allows for bound states in \He{6} where there were none in \He{5}.\todo[inline]{were none or was none?}
...
\end{eq}
To make the calculations more managable, a \emph{separable} interaction can be chosen. An arbitrary function $V = V(\vec{r}_1 - \vec{r}_2)$ can be expanded in a \emph{multipole expansion},\todo{cite souhonen somewhere}
