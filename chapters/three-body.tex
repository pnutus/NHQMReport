...
\begin{itemize}
  \item State problem in Fock space
  \item Coupling (or does it belong in many-body chapter?)
  \item Interactions
  \begin{itemize}
    \item Gaussian
    \item Delta
  \end{itemize}
  \item \He{6} and the specifics of our problem
  \item Solutions/results
\end{itemize}
...
\begin{figure}
  \centering
    \begin{tikzpicture}
      ...
      \end{axis}
    \end{tikzpicture}
  \caption{The Gaussian interaction as seen by one of the neutrons. The position of the other neutron determines the depth of the potential well.}
  \label{fig:gaussian}
\end{figure}
...
\section{Neutron-Core Interaction}
