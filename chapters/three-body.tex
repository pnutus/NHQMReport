...
\end{eq} 
where $E_1$, $E_2$ (and thus $k_1$, $k_2$) are the energies of two \He{5} eigenstates. These solutions can be interpreted as two unbound particles, barely interacting with each other. This also explains the pattern that is seen---the solutions are all combinations of contour points that was used in the solution of \He{5} to generate the sp basis. 
