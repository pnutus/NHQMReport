...
\begin{figure}
  ...
  \caption{Three different quantum systems: the closed harmonic oscillator, a free particle and an open gaussian well.}
  \label{fig:potentials}
\end{figure}
\todo{Update figure to post-presentation?}
...
The methods will be used to study the simple nuclear systems \He{5} and \He{6}, comparing the results to experimental data.
...
\todo{tar vi bort ringarna?}

We solve the TISE numerically, but do not focus on computational aspects, such as performance, as these have not been an issue in our work.
