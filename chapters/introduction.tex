...
An open system can also have bound states.\todo{"but not necessarily"?}
...
This can be expressed mathematically if we let the resonance have\todo{correspond to.} a complex energy, as the following argument suggests.
...
However, complex eigenvalues pose a problem in standard quantum mechanics, since it postulates that operators be\todo{to be?} Hermitian. \todo[inline]{är it tydligt syftat?}
