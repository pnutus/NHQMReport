...
However, complex eigenvalues pose a problem in standard quantum mechanics, since it postulates that operators be Hermitian. \todo[inline]{är it tydligt syftat?}
