...
A resonance wavefunction is localized for a finite amount of time, as opposed to a bound, \emph{stationary} state that forever stays the same.
...
To demonstrate the methods, we will study the simple nuclear systems \He{5} and \He{6}, since the ground state of \He{5} and the first excited state of both \He{5} and \He{6} are resonances. 
