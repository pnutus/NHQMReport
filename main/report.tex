...
We study resonances using as model systems \He{5} and \He{6},\todo{Stange sentence.} treated as an alpha-particle core with one and two valence neutrons respectively.
...
With the Berggren basis, we reproduce the known resonances in \He{5} within XXX\%.\todo{Again, do we reproduce?}
...
We used the Ti$k$Z and pgfplots libraries to make the figures. 
