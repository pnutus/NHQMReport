...
\begin{document}
   ...
   \begin{tikzpicture}
     \begin{axis}[
       ...
       \addplot+[only marks, very thick] table [x index =0, y index =1] {poles.data};
       \addlegendentry{Pole position}
       \addplot+[no marks, very thick] table [x index =0, y index =1] {contour.data};
   ...
   \begin{tikzpicture}
     \begin{axis}[
       legend style={at={(0.8,0.5)}, anchor=north,legend columns=1},
       xlabel=Re $k/\b{\si{fm^{-1}}}$]
       \addplot+[only marks, very thick] table [x index =2, y index =3] {poles.data};
       \addlegendentry{Pole position}
       \addplot+[no marks, very thick] table [x index =0, y index =1] {contour.data};
       \addlegendentry{Contour}
     \end{axis}
