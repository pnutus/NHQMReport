...
\begin{align}
 a_{\alpha}^{\dagger} & | \alpha_1 \alpha_2 ... \alpha_N> &&= |\alpha \alpha_1 \alpha_2 ... \alpha_N> \label{eq:creation}
\\ 
 a_{\alpha}^{\dagger} & |\alpha \alpha_1 \alpha_2 ... \alpha_N> &&= 0 \label{eq:creation zero}
\\ 
